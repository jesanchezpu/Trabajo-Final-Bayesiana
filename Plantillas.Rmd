...
ggplot(datos, aes(x,y))+ 
  ...
  ggtitle ("Precio de un mazda 3 modelo 2010 en millones de pesos")+
...
ggplot(datos, aes(x,y))+ 
  ...
  geom_vline(xintercept=seq(0, 150, 5), color="gray")+
  geom_hline(yintercept=c(0,5,15,20,35,50,60,75,90,95,100), color="gray")+
  ggtitle ("Precio de un mazda 3 modelo 2015 en millones de pesos")+
  theme(plot.title = element_text(hjust = 0.5))
```
...
ggplot(datos, aes(x,y))+ 
  ...
  geom_vline(xintercept=seq(0, 150, 5), color="gray")+
  geom_hline(yintercept=c(0,5,15,20,35,50,60,75,90,95,100), color="gray")+
  ggtitle ("Precio de un mazda 3 modelo 2020 en millones de pesos")+
  theme(plot.title = element_text(hjust = 0.5))
```